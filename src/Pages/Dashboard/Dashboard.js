			...
			<MDBContainer>
				<MDBRow>
					<div className='mt-5 mb-3 py-3 text-center text-md-start'>
						<MDBBtn color='success shadow-0 me-3' style={currentComponent === 'A' ? { opacity: 0.5 } : {}} onClick={handleClickOverview} size='md'>Overview</MDBBtn>
						<MDBBtn color='success shadow-0' style={currentComponent === 'B' ? { opacity: 0.5 } : {}} onClick={handleClickPrediction} size='md'>Get started</MDBBtn>
					</div>
